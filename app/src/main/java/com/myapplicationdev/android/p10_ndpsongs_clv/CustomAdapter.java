...
public class CustomAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvyr = rowView.findViewById(R.id.songyr);
        TextView tvname = rowView.findViewById(R.id.singername);

        ImageView iv = rowView.findViewById(R.id.sticker);
        RatingBar rb = rowView.findViewById(R.id.ratingBar2);

        // Obtain the Android Version information based on the position
        Song currentVersion = verlist.get(position);
